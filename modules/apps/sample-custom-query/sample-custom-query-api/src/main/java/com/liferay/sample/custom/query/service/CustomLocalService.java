...
/**
 * Provides the local service interface for Custom. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CustomLocalServiceUtil
...
public interface CustomLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomLocalServiceUtil} to access the custom local service. Add custom service methods to {@link com.liferay.sample.custom.query.service.impl.CustomLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Custom createCustom(long customId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Custom deleteCustom(long customId) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Custom fetchCustom(long customId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Custom getCustom(long customId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Custom> getCustoms(int start, int end);
